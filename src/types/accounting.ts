...
export interface Invoice {
  ...
  customer: string;
  /** Links this invoice to a real Customer record when known -- optional
   * since most invoices only ever captured the customer's name. The
   * Customer Portal prefers this over name-matching when present. */
  customerId?: string;
  jobId?: string;
  estimateId?: string;
  /** Set when this invoice was auto-generated by a recurring Membership/Service Agreement billing cycle. */
  membershipId?: string;
