  ...
  const [notifList, setNotifList] = useState<DetailedNotification[]>([
    {
      ...
      category: "revenue",
      title: "Invoice Paid",
      description: "Invoice #INV-2026-881 for $4,850.00 was marked PAID by QuickBooks Sync.",
      ...
      notes: "Auto-synced from QuickBooks online merchant account. Applied to Drainage Project.",
      createdBy: "QuickBooks System",
      history: ["2026-07-06 14:30: Generated by QuickBooks sync.", "2026-07-06 14:31: Assigned to Sarah Jenkins."]
    },
    {
      id: "notif_2",
      category: "estimates",
      title: "Estimate Approved",
      description: "Estimate #EST-1092 ($6,200.00) approved online by customer Theresa Webb.",
      time: "2026-07-06 10:24",
      isRead: false,
      isArchived: false,
      isPinned: true,
      priority: "High",
      ...
      relatedCustomer: "Theresa Webb",
      notes: "E-signature collected securely. Awaiting deposit validation.",
      createdBy: "LeadForge Portal",
      history: ["2026-07-06 10:24: Customer approved and signed estimate."]
    },
    {
      id: "notif_3",
      category: "scheduling",
      title: "Conflict Detected",
      description: "Double booking warning: Crew Alpha assigned to both Site Survey and Drainage Project at 11:30.",
      time: "2026-07-06 09:15",
      isRead: false,
      isArchived: false,
      isPinned: false,
      priority: "Critical",
      assignedUser: "Pete (Dispatch)",
      notes: "Valkyrie Crew Alpha overlaps. Recommend shifting Site Survey to 14:00.",
      createdBy: "Event Engine Router",
      history: ["2026-07-06 09:15: Collision detector detected Crew Alpha overlap."]
    },
    {
      id: "notif_4",
      category: "inventory",
      title: "Low Stock Alert",
      description: "PVC 3-inch pressure pipe stock dropped to 8 units (Threshold: 15).",
      time: "2026-07-05 16:45",
      isRead: true,
      isArchived: false,
      isPinned: false,
      priority: "High",
      assignedUser: "John Warehouse",
      notes: "Automatic purchase order candidate generated.",
      createdBy: "Inventory Monitor",
      history: ["2026-07-05 16:45: Quantity updated below threshold during PO-2026-991 checkout."]
    },
    {
      id: "notif_5",
      category: "ai",
      title: "Suggested Follow-up",
      description: "AI Insight: Lead 'David Miller' has been inactive for 72 hours since Estimate Sent.",
      ...
      priority: "Normal",
      assignedUser: "Marcus Vance",
      relatedCustomer: "David Miller",
      notes: "Gemini recommends sending follow-up template 'Estimate Followup B' with 5% discount nudge.",
      createdBy: "Gemini LeadForge AI",
      history: ["2026-07-05 12:00: Generated by daily AI prioritization sweep."]
    },
    {
      id: "notif_6",
      category: "system",
      title: "Integration Error",
      description: "Google Maps API returned billing over-quota limits on dispatch routing engine.",
      time: "2026-07-05 08:30",
      isRead: true,
      isArchived: false,
      isPinned: false,
      priority: "Critical",
      assignedUser: "Owner",
      notes: "Verify credentials and payment profile in Google Cloud Console. System fell back to open routing metrics.",
      createdBy: "System Overseer",
      history: ["2026-07-05 08:30: Maps sync failed with status 403 Over Quota."]
    },
    {
      id: "notif_7",
      category: "dispatch",
      title: "Crew Running Late",
      description: "Crew Beta is delayed by heavy traffic on I-5 South (ETA +25 mins to 1420 Pine St).",
      time: "2026-07-06 13:10",
      isRead: false,
      isArchived: false,
      isPinned: false,
      priority: "High",
      assignedUser: "Pete (Dispatch)",
      relatedCustomer: "Marcus Vance",
      notes: "Automatic Missed Call Text Back template dispatched to customer notifying of delay.",
      createdBy: "Dispatch Telematics",
      history: ["2026-07-06 13:10: Telematics geofence delay flagged."]
    },
    {
      id: "notif_8",
      category: "training",
      title: "Course Assigned",
      description: "New OSHA HazMat safety regulations curriculum assigned to all field technicians.",
      time: "2026-07-04 10:00",
      isRead: true,
      isArchived: false,
      isPinned: false,
      priority: "Low",
      assignedUser: "All Technicians",
      notes: "Due date: July 31st, 2026. Includes 5-question mandatory safety quiz.",
      createdBy: "Roster Training Suite",
      history: ["2026-07-04 10:00: Curricula assigned by Office Manager."]
    },
    {
      id: "notif_9",
      category: "custom",
      title: "Site Preparation Checklist",
      description: "Manual Reminder: Confirm utility marking complete before Friday excavation.",
      time: "2026-07-06 15:00",
      isRead: false,
      isArchived: false,
      isPinned: true,
      priority: "Normal",
      assignedUser: "Theresa W.",
      relatedCustomer: "Theresa Webb",
      notes: "Owner custom checklist item.",
      createdBy: "Owner",
      history: ["2026-07-06 15:00: Checklist manually injected into shared timeline."]
    }
  ]);
                  ...
                  <div className="relative">
                    ...
                    {showAssignMenu && (
                      <div className="absolute bottom-11 left-0 bg-[#C7E3FB] text-[#1F3557] rounded-xl border border-[#9EC8EF] shadow-lg p-2.5 w-48 z-50 text-xs font-bold space-y-1">
                        {["Sarah Jenkins", "Marcus Vance", "Pete (Dispatch)", "Theresa W.", "John Warehouse"].map((user) => (
                          <button
                            key={user}
                            onClick={() => {
